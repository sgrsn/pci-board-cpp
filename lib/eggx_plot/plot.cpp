...
void Plot::drawAxis()
{
  setLayer();
  int fontsize = 10;
  eggx_window(win_, xmin_-fontsize, ymin_-fontsize, xmax_+fontsize, ymax_+fontsize);
  ...
  eggx_drawstr(win_, xmin_, ymin_-fontsize, fontsize, 0.0, "%f", xmin_);
  eggx_drawstr(win_, xmax_, ymin_-fontsize, fontsize, 0.0, "%f", xmax_);
